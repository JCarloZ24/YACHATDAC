...
`public/media/wonder/wonder-hero-{960,1440,1920}.mp4` are the three served encodes of the
hero film (60.04s, 1501 frames). They are **loudness-normalised, and a replacement must be
too** — the delivered mix startled visitors who turned the sound on.
...
## The portrait re-cut — brief for the editor (raised 10 September 2026)
