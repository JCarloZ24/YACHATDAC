 ...
 *
 * A copy of src/lib/motion/home-hero.ts, owned by /homepagev2 alone. The two
...
import { HOME_PAINTING, HOME_PORTAL } from "../_content/kit-home";
    ...
    const build = async () => {
      try {
        ...
        const goToWonder = (event: MouseEvent) => {
          ...
          const trigger = ScrollTrigger.getById("homev2-hero-dissolve");
        ...
        context = gsap.context(() => {
          registerHomeV2();
          breeze = gsap.effects.homeV2LandscapeBreeze(root, {
