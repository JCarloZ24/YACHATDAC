...
export function OurPeopleCanvas() {
  ...
  useGSAP(() => {
    ...
    // The advisory entrance latch (data-people-entered) went with the
    // advisory screen, 15 September 2026: the notice is on the loading cover.
    ...
    return () => { cancelled = true; unregisterPatterns(); unregister?.(); };
  }, { scope: canvas });
