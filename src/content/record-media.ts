 ...
 */
export const recordHeroSlot: MediaSlot = {
  id: "record-hero",
  bucket: "country",
  expects:
 ...
 */
export const recordGrowsSlot: MediaSlot = {
  id: "record-grows",
  bucket: "work",
  expects:
 ...
 */
export const recordCardMedia: Record<string, MediaSlot> = {
  ...
  "fifteen-thousand-markings-read-in-order": {
    id: "card-markings",
    bucket: "story-wall",
    expects: "A hand resting on the engraved sandstone, the markings running under it",
 ...
 */
export const recordBreakoutMedia: Record<string, MediaSlot | null> = {
