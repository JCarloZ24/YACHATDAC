 ...
 * over: the route is `/the-record`, the nav label is The Record, and this
 * module is named for it. Renamed at August's direction, which AMENDS decision
 * **D1** ("one page, labelled Resources", Final 20 Aug, Marc and Ivy) — the
 ...
 *
 * Truth links `/the-record/cultural-knowledge-precinct` from its Precinct
