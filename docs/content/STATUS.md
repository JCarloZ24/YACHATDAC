...
| `src/content/page-specs.ts` | Truth as a section stack, not a reverse chronology (note 5). "2 Night, 3 Day Guesting on Country experience" no longer exists (note 7). | ✅ **Synced to v2, 28 Aug.** Truth rewritten as the present-to-past chronology (hero → ahead → today → 2022 → 2026 back to 2003 → 1950s → the seam → 1840s → the engraving → before people), with the two v2 inline cards (partnerships, open research) kept as their own stub entries. Wonder's "The Experience" replaced with "What a stay looks like" as stages, itinerary-validation note removed (closed per open-questions.md), R13's unconfirmed inclusions/cost flagged instead. |
