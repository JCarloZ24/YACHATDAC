...
> `YACHATDAC-Wonder-Guesting.html` (Drive export
> `drive-download-20260824T052412Z-1-001`, received 24 August 2026). Prototype
> title: *Guesting On-Country — YACHATDAC*.
>
...
>
> **Images.** The prototype's 30 embedded photographs (base64 JPEG, ~4.2 MB)
...
Home › Wonder › Guesting On-Country

[ Image — Guests standing with Suzanne beneath the engraved escarpment wall at Marra Wonga. ]

[ Image — Camp chairs and tents around a fire at dusk. ]

[ Image — Red dirt road running out under a big sky. ]

[ Image — Suzanne pointing out features along the shelter wall. ]

[ Image — Suzanne handing lemongrass to a guest. ]

[ Image — A group walking through woodland toward the escarpment. ]

[ Image — Pitching a tent at camp. ]

[ Image — Fossil footprints in the rock. ]

[ Image — The escarpment seen from a distance. ]
...
Turraburra, 120km north of Barcaldine
...
Half-day walks through to multi-day stays

Sleeping

Camping — swag or tent, shared meals, fire at night
...
Families, school groups, group bookings, international visitors
...
160 metres of sandstone carrying fifteen thousand markings, read south to north.

[ Image — Lemongrass passed hand to hand. ]

**Native foods**

##### Country you can eat from

Herbs, fruits, seeds and nuts, in scrub that looked empty on the drive in.
...
The escarpment runs along the edge of the Aramac Range.
...
### Stories from out here [See all →](/resources/?tag=lore)

Pulled from the Resources collection, tagged **#lore**, **#country** and **#guesting**.
...
[Read more →](/resources/wattanuri-and-the-ones-he-followed)
...
[Read more →](/resources/bringing-a-spring-back)
...
Download the brochure to share, print, or read offline.

Download PDF

> [ FUTURE — reviews from groups who have already been. ]

#### Come and see it

Dates move with the seasons and with the people hosting you, so we arrange them with you directly rather than off a list.
...
> No fixed dates and no pricing on this page — every stay is arranged with you.
