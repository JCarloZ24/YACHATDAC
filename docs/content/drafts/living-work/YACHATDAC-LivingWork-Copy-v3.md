# Living Work — draft copy v3

> **Page:** Living Work · **Version:** v3 · **State:** draft ·
> **Governance circle:** shared with care
>
> **Source.** Converted from the client's HTML prototype
> `YACHATDAC-Living-work.html` (Drive export
...
>
> **Images.** The prototype's 15 embedded photographs (base64 JPEG, ~2.1 MB)
...
**Degraded springs and waterholes**
...
**Extreme heat, drought and flood**
...
See Infrastructure below for how the property stays connected.

**Water security across 8,870 hectares**
...
**Species we have not yet identified**
...
**Ranger funding ahead of income**
...
[ Image — Showing plants to a visiting group. ]

Showing plants to a visiting group.

[ Image — Working along the escarpment. ]

Working along the escarpment.

[ Image — Morning briefing by the water. ]

Morning briefing by the water.

[ Image — Seed collecting in the scrub. ]

Seed collecting in the scrub.

[ Image — At the shelter wall. ]

At the shelter wall.

[ Image — On top of the escarpment. ]
...
Bringing cultural wetlands and spring networks back to holding water on their own.
...
#### Seed and groundcover

Collecting seed when Country produces it, holding it, and putting it back into revegetation.
...
New fencing built corner assembly by corner assembly, giving paddocks that can be managed separately.
...
Continuous control targeted at the places doing the most damage — waterholes, regrowth and rock shelters.
...
Protecting Marra Wonga and the other recorded sites, and controlling how people reach them.
...
Recording what is here and what changes, so management decisions and credit claims both rest on evidence.
...
Direct-to-handset satellite messaging is expected to change this within a couple of years.
...
The register is the reason a town run can be planned in one trip.
...
Species of significance are being identified and monitored. The same data that guides management underpins any credit work.

##### IPA designation

In progress

Indigenous Protected Area status for Turraburra, alongside National and World Heritage applications and the Four Rivers People Native Title claim.
...
Integrating environmental and traditional land management into a single natural-capital product. Needs describing in your words: what it is, what is measured, who it is for, and where it sits with the Rainbow Foundation.

[ Status labels to be confirmed before publishing. ]

[ Image — People walking through woodland toward the escarpment. ]

Get involved

### Ancient traditions walking together with contemporary visions
...
Ranger wages, water infrastructure, monitoring equipment and restoration. What is needed is specific and can be costed.
