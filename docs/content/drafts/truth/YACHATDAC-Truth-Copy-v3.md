...
>
> **Source.** Converted from the client's HTML prototype
> `YACHATDAC-The-truth-August-20-2026.html` (Drive export
...
> decision **D5** this file governs **copy only**; the wireframes govern
> design. Where the prototype implies a layout, treat it as a suggestion.
>
> **Images.** The prototype's 3 embedded photographs (base64 JPEG, ~0.4 MB)
...
## Most people have never heard of the Iningai.

This is what happened here, told by the people it happened to.

[Start from the beginning ↓](#beginning)
...
#### [The Cultural Knowledge Precinct](/resources/cultural-knowledge-precinct)
...
[ Image — Architectural render of the Cultural Knowledge Precinct, a curved timber lattice canopy over an open gathering space, with visitors walking on red earth. ]

> Concept render of the Cultural Knowledge Precinct.

It is being built because there is something here worth building it for.

Written record

[Talk to us about being part of it →](#partner)
...
#### [The site is studied with its owners](/resources/fifteen-thousand-markings-read-in-order)
...
[Read the findings →](/resources/fifteen-thousand-markings-read-in-order)
...
[Explore our discoveries →](/resources/#research-and-discovery)

[ Image — Full-bleed break — Country now first light over the range, or a spring running ]
...
#### [The deed of grant](/resources/it-nearly-didnt-happen)

Turraburra is signed over outright. No longer held on our behalf, no longer shackled to anyone else’s conditions.

[ Image — Two people at a table on a timber deck, each at a laptop, a dog asleep beside them. ]

> Signing at 12:15pm. Suzanne had finished telling the story of the buyback minutes earlier, then opened the laptop.

Owning it outright is not the same as getting it back. Getting it back took seven years longer, and nearly did not happen at all.

Written record

[Suzanne’s account of how it happened →](/resources/it-nearly-didnt-happen)
...
The name went back before the deed did.

Written record

2:30pm, 30 April 2019

#### [And then it was just us](/resources/it-nearly-didnt-happen)
...
It had to be bought incognito. Once anyone knew who the money was really for, the price would have gone up.

Living memory

[Read what it took →](/resources/it-nearly-didnt-happen)

2003

#### [Suzanne’s father](/resources/it-nearly-didnt-happen)
...
[My father’s dream →](/resources/it-nearly-didnt-happen)

1950s

### Admired under the wrong name

1950s

#### [They called it The Art Gallery](/resources/when-they-called-it-the-art-gallery)
...
[Who named it, and what it was called before →](/resources/when-they-called-it-the-art-gallery)

1902, and then further back
...
### By 1902 there were thirty-seven.
...
*Iningai custodian · Founder and Managing Director, YACHATDAC*

> And I’m a descendant of one of those 37.

To understand that number you have to go back sixteen years, to a drought, and to a decision made out of concern.

1902 37 Iningai adults recorded in the area, and three children.

1886 7,500 Blankets calculated as necessary for the Iningai nation, sixteen years earlier. When they arrived, some still had to be cut in half, because there were not enough to go round.
...
> **Build note** — *The descent stops here. No rail, no markers, nothing else on screen, and no way past it. It resumes below, older.*

Lore — continuous

1840s

### Before the runs were taken up

1840s

#### [What Mitchell recorded](/resources/what-mitchell-wrote-down)
...
[ Image — Document — not a photo scan of the journal page ]

Written record

[Read the passage, and what it proves →](/resources/what-mitchell-wrote-down)

Older than the record

### Cut into the wall

Older than 5,000 years, and nobody knows how much older

#### [The engraving starts](/resources/fifteen-thousand-markings-read-in-order)
...
[What the study found, and how →](/resources/fifteen-thousand-markings-read-in-order)

Published as [Marra Wonga: Archaeological and contemporary First Nations interpretations of one of central Queensland’s largest rock art sites](https://www.tandfonline.com/doi/full/10.1080/03122417.2022.2084666), *Australian Archaeology*, 2022.
...
Before people · about 100 million years ago
...
Almost none of it has been studied.

[How the seabed became the escarpment →](/resources/you-are-standing-on-a-seabed)
