...
> `YACHATDAC-About.html` (Drive export
...
>
> **Images.** The prototype's one embedded photograph (base64 JPEG) was
> **not** imported. `[ Image — … ]` markers record what each slot is meant to
> carry. Per STATUS note 12 the photography is placeholder direction, not an
> asset manifest.
>
...
**Charity status** — Registered with the ACNC

**Owned by** — Its members — Iningai Traditional Custodian families

**Based** — Barcaldine, Central Western Queensland
...
> What does it leave for the generations who come after us?
...
Four things, and they hold each other up. If Country is not cared for there is nothing to harvest; if there is nothing to harvest there is no knowledge to share; if the knowledge is not shared it does not survive.

#### Caring for Country

Fire-stick farming, land restoration, wildlife conservation, carbon and biodiversity — delivered by Iningai Rangers.

[Field notes from Turraburra →](/living-work)

#### Cultural heritage

Protecting Marra Wonga and the other sites, recovering language and story, and telling the truth of what happened here.

[Truth →](/truth)

#### Guesting On-Country

Bringing people onto Country as guests rather than tourists, and sharing what we are able to share.

[Guesting On-Country →](/wonder)

#### Research and the record

Two-way science with universities, and a public record of what is known about this Country.

[The Record →](/resources)

### How we work

**Country first** — Every decision respects Country — land, waters and sky, its ecological values and its cultural significance. Where Country and commercial sense disagree, Country wins.
...
[Governance documents, the Ten Year Plan and our financial statements are in The Record →](/resources)
...
We work with universities, government and community organisations. Research on Turraburra is done with Iningai people as partners rather than subjects, and every partnership is expected to give something back to the land and the people.
...
**Office** — Barcaldine, Central Western Queensland
[ street address ]

**Postal** — [ PO Box, Barcaldine QLD 4725 ]

**Email** — [ info@yachatdac.com.au ]

**Phone** — [ number ]

**Registration** — ICN [ number ] · ABN [ number ]

#### What are you after?

Different things go to different people. Tell us which and it reaches the right person faster.

[**Coming on Country** — Guesting, school groups, bookings](/wonder)

[**Research or partnership** — Universities, funders, brands](/truth#partner)

[**Ranger exchange** — Other First Nations groups](/connect)
